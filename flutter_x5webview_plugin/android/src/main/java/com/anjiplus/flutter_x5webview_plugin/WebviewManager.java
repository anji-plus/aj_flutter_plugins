    ...
    WebviewManager(final Activity activity, final Context context) {
                    ...
                    switch (keyCode) {
                        case KeyEvent.KEYCODE_BACK:
                            if (webView.canGoBack()) {
                                ...
                                FlutterX5webviewPlugin.channel.invokeMethod("onBack", null);
                            }
                            return true;
                    }
                }
        ...
        ((ObservableWebView) webView).setOnScrollChangedCallback(new ObservableWebView.OnScrollChangedCallback() {
            public void onScroll(int x, int y, int oldx, int oldy) {
                ...
                FlutterX5webviewPlugin.channel.invokeMethod("onScrollYChanged", yDirection);
                Map<String, Object> xDirection = new HashMap<>();
                xDirection.put("xDirection", (double) x);
                FlutterX5webviewPlugin.channel.invokeMethod("onScrollXChanged", xDirection);
            }
        });
...
//                activity.startActivityForResult(chooserIntent, FILECHOOSER_RESULTCODE);
            ...
            public void onProgressChanged(WebView view, int progress) {
                ...
                FlutterX5webviewPlugin.channel.invokeMethod("onProgressChanged", args);
            }
        });
    }
...
//                            }
    ...
    void openUrl(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            webView.getSettings().setMixedContentMode(WebSettings.LOAD_NO_CACHE);
        }
    ...
    void close(MethodCall call, MethodChannel.Result result) {
        ...
        closed = true;
        FlutterX5webviewPlugin.channel.invokeMethod("onDestroy", null);
    }
