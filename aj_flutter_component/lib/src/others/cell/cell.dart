...
class AJCells extends StatelessWidget {
...
class AJCell extends StatelessWidget {
  // label
  final Widget label;
  // 内容
  ...
  Widget build(BuildContext context) {
    ...
    final _AJCellsScope weCellsScope = _AJCellsScope.of(context);
...
class _AJCellsScope extends InheritedWidget {
  final AJCells weCells;
  ...
  static _AJCellsScope of(BuildContext context) {
    return context.inheritFromWidgetOfExactType(_AJCellsScope);
  }

  @override
  bool updateShouldNotify(_AJCellsScope oldWidget) {
    return true;
  }
}
