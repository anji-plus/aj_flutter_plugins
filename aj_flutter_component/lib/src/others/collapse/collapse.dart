...
class AJCollapse extends StatefulWidget {
  // 数据
  ...
  @override
  AJCollapseState createState() => AJCollapseState();
}

class AJCollapseState extends State<AJCollapse> {
  // 内容左右padding
  ...
  void didChangeDependencies() {
    ...
    border = Divider(height: 1, color: AJUi.getTheme(context).defaultBorderColor);
  }
  ...
  // 渲染title
  Widget buildTitle(String key, int index, AJCollapseItem item) {
          ...
          child: Row(
              children: [
                ...
                Transform.rotate(
                    ...
                    child: Icon(AJIcons.down, size: 26.0, color: Color(0xff969799))
                )
              ]
          )
      );
  ...
  Widget buildItem(String key, int index, AJCollapseItem item) {
