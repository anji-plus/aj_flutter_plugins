...
class AJCheckboxGroup<T> extends StatefulWidget {
  // 最大选中数限制
  final int max;
  // 默认值
  ...
  @override
  AJCheckboxGroupState createState() => AJCheckboxGroupState<T>();
}

class AJCheckboxGroupState<T> extends State<AJCheckboxGroup> {
  List<T> value = [];
  ...
  @override
  void didUpdateWidget(AJCheckboxGroup oldWidget) {
...
class AJCheckbox<T> extends StatefulWidget {
  // 禁用状态
  final bool disabled;
  // 选中的value
  final T value;
  ...
  @override
  AJCheckboxState createState() => AJCheckboxState();
}

class AJCheckboxState extends State<AJCheckbox> {
...
class CheckboxGroupScope extends InheritedWidget {
  final AJCheckboxGroupState checkboxGroup;
