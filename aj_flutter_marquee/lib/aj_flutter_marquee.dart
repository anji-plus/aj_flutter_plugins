library aj_flutter_marquee;

import 'dart:async';
import 'package:flutter/material.dart';

/**
 * 备注：AJMarqueeWidget 需要使用块状Container设置宽高使用，具体使用可见 aj_flutter_marquee_test.dart文件
 * */

class AJMarqueeWidget extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return new AJMarqueeWidgetState();
  }
}

class AJMarqueeWidgetState extends State<AJMarqueeWidget> with SingleTickerProviderStateMixin{
  ...
  Widget getBothEndsChild(){
    if(widget.scrollAxis == Axis.vertical){
      ...
      return new Center(
        child: new Text(
          newString,style: widget.textStyle,
